...
```bash copy
# Export logs as JSON for a specific time window
lakerunner-cli logs get --start "2024-06-01T00:00:00Z" --end "2024-06-01T01:00:00Z" --columns "timestamp,level,message"
```
