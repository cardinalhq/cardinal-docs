...
*(If your telemetry data volume is high, and you prefer not to send it all to Cardinal, refer to the [Cardinal OpenTelemetry Collector](/chip/otel-collectors/cardinal-collector) section for an alternative)*
