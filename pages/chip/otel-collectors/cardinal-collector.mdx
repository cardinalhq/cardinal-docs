...
*(If your telemetry data volume is low, or you prefer to not install a new Collector, refer to the [OTLP Export to Cardinal](/chip/otel-collectors/export-to-cardinal) section for an alternative)*
