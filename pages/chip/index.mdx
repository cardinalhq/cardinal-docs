...
<Image src="/chip_right.png" alt="Chip" width={200} height={200} />

Ready to see how [Chip](https://cardinalhq.io/chip) can get you from instrumentation to **incident-ready** in minutes? 🚀
...
- [Node.js](/chip/app-instrumentation/nodejs)
- [Python](/chip/app-instrumentation/python)
- [Java](/chip/app-instrumentation/java)
- [Go](/chip/app-instrumentation/go)
- [React.js](/chip/app-instrumentation/reactjs)
...
[Add an OTLP Exporter to send data to Cardinal](/chip/otel-collectors/export-to-cardinal) 
  - Recommended for fast onboarding, PoCs, or if your telemetry data volume is low
  - Sends raw telemetry data to Cardinal

OR

[Install the Cardinal OpenTelemetry Collector](/chip/otel-collectors/cardinal-collector)
