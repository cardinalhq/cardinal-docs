...
3. Follow the steps in the [Additional Integrations](#additional-integrations) section below to instrument your application, depending on the libraries you are using in your application.
