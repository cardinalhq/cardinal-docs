...
export OTEL_EXPORTER_OTLP_ENDPOINT="https://intake-otlphttp.us-east-2.aws.cardinalhq.io"
...
Set the environment variables outlined above in your Docker container runtime configuration, and update the `CMD` in your `Dockerfile` to include `opentelemetry-instrument`. 
