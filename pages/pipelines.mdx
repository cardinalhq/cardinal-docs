...
# CardinalHQ Managed Collectors

CardinalHQ Managed Collectors are a remotely configurable layer on top of the OpenTelemetry Collector, designed to simplify and streamline how you gather, process, and send telemetry data. By leveraging CardinalHQ, you gain operational visibility and control over every stage of your telemetry pipeline—without manually configuring or maintaining collectors across your environment.

## Pipeline Telemetry & Remote Management

At the heart of CardinalHQ’s solution are **Collector Pipelines**, which define how telemetry flows from sources to destinations through a series of processors and rules. With CardinalHQ, you can:
...
CardinalHQ doesn’t just orchestrate the pipeline; it also provides granular insights into its operation:
...
<div style={{display:'flex', gap:16, flexDirection:'column' }}>
    <ExpandableImage url={'/docs_pipeline.png'} alt={'Pipeline'} imgStyle={{width:500, margin:30}}/>
    <div>Managed processor rules</div>
    <ExpandableImage url={'/docs_rules.png'} alt={'Rules'} imgStyle={{width:500, margin:30}}/>
</div>
