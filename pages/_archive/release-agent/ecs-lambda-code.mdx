...
4. Deploy using the [CloudFormation template](./ecs-cfn-reference)

## Related Pages

- [ECS Deployment Tracking Guide](./ecs) - Complete setup guide
- [ECS CloudFormation Template](./ecs-cfn-reference) - Infrastructure template
