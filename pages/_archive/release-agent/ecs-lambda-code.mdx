...
4. Deploy using the [CloudFormation template](/agent-builder/release-agent/ecs-cfn-reference)

## Related Pages

- [ECS Deployment Tracking Guide](/agent-builder/release-agent/ecs) - Complete setup guide
- [ECS CloudFormation Template](/agent-builder/release-agent/ecs-cfn-reference) - Infrastructure template
