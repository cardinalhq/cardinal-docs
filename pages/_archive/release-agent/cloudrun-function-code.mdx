...
2. Deploy using the [Terraform configuration](./cloudrun-terraform-reference):
   ```bash
   cd terraform
   terraform init
   terraform apply
...
- [CloudRun Deployment Tracking Guide](./cloudrun) - Complete setup guide
- [CloudRun Terraform Configuration](./cloudrun-terraform-reference) - Infrastructure configuration
