...
2. Deploy using the [Terraform configuration](/agent-builder/release-agent/cloudrun-terraform-reference):
   ```bash
   cd terraform
   terraform init
   terraform apply
...
- [CloudRun Deployment Tracking Guide](/agent-builder/release-agent/cloudrun) - Complete setup guide
- [CloudRun Terraform Configuration](/agent-builder/release-agent/cloudrun-terraform-reference) - Infrastructure configuration
