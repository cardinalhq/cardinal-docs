...
2. Save all files:
   - `main.py` - See [CloudRun function code](/agent-builder/release-agent/cloudrun-function-code)
   - `requirements.txt`
...
- [CloudRun Function Code](/agent-builder/release-agent/cloudrun-function-code) - Python function implementation
