...
Invoke the release check workflow via a simple HTTP webhook as part of your GitHub Actions, or any other CI/CD pipeline, to validate your deployments.
...
- Replace `{your-agent-url}` with the HTTP webhook URL for your Agent, which is displayed in the Launch Status card, as outlined in the [Launch Agents](/agent-builder/product/launch-agents#4-invoke-agents-via-http-webhook) guide.
...
You can now also customize the release check to fit your exact needs by updating the included [Workflows](/agent-builder/product/assets/workflows) and [Scripts](/agent-builder/product/assets/scripts), or adding your own.
