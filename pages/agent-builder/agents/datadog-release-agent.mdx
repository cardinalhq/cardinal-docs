...
If this is your first time using Cardinal VibeShield, follow the [Get Started](/agent-builder/get_started) guide to sign up for a free Cardinal account, and set up your team's workspace.
