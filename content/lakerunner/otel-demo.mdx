...
- A running Lakerunner installation (see the [Manual install](/lakerunner/manual-install))
...
Open Grafana (see [Manual install](/lakerunner/manual-install)) and navigate to **Explore**. You should see:
