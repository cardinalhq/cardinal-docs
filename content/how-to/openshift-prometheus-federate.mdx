...
| Exporter | Use when |
| -------- | -------- |
| `awss3` | Writing OTLP-proto metrics to S3 for Cardinal Data Lake. |
  ...
  items={[
    {
      ...
      description: 'Land federated metrics in S3 and query them with Cardinal Data Lake.',
      href: '/data-lake',
    },
    {
      icon: '📡',
