...
<Prerequisites
  items={[
    ...
    },
    {
      ...
      alt: <>Network reachability from the OpenShift nodes to your collector gateway / Cardinal Data Lake / vendor OTLP endpoint.</>,
    },
  ]}
/>
...
| ----------- | ----------------- |
| `<your-ocp-cluster-name>` | A stable identifier for this cluster. It is stamped onto every record as `k8s.cluster.name`, which downstream consumers (Cardinal Data Lake, dashboards, alerting) use to partition by source. |
  ...
  items={[
    {
      ...
      description: 'Land OTLP logs in S3 and query them with Cardinal Data Lake.',
      href: '/data-lake',
    },
    {
      icon: '📡',
