...
Use this calculator to estimate the compute resources (vCPU and memory) required for your Cardinal Data Lake deployment based on your expected telemetry throughput.
