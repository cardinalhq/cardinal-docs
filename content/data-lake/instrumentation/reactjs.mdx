...
Follow the steps below to auto-instrument your React.js web app. When complete, your app will start emitting traces to Cardinal Data Lake.
...
3. Set up a backend endpoint to proxy traces.
   ...
   To get an API key, follow the steps in the [Overview](/data-lake/instrumentation#get-an-api-key).
