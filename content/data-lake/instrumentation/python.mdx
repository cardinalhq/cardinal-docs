...
Follow the steps below to auto-instrument your Python service. When complete, your service will start emitting logs, metrics, and traces to Cardinal Data Lake.
