...
Follow the steps below to auto-instrument your Node.js service. When complete, your service will start emitting logs, metrics, and traces to Cardinal Data Lake.
...
6. Validate that Cardinal Data Lake is receiving data.
...
Configure [Pino](https://getpino.io/) to forward logs to Cardinal Data Lake.
