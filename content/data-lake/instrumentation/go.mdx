...
Follow the steps below to instrument your Go service. When complete, your service will start emitting logs, metrics, and traces to Cardinal Data Lake.
...
To instrument your Go application, set up the OpenTelemetry SDK and configure it to export data to Cardinal Data Lake.
