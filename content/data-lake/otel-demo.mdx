...
The [OpenTelemetry Demo](https://opentelemetry.io/docs/demo/) is a microservices-based e-commerce application that generates realistic logs, metrics, and traces. It's a great way to see Cardinal Data Lake in action with real-world telemetry.
...
- A running Cardinal Data Lake installation (see the [Manual install](/data-lake/manual-install))
...
# Disable built-in observability backends — Cardinal Data Lake replaces them
jaeger:
  enabled: false
prometheus:
  enabled: false
...
Open Grafana (see [Manual install](/data-lake/manual-install)) and navigate to **Explore**. You should see:
