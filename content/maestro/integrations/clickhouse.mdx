...
Connect Cardinal Cloud to ClickHouse to explore schemas and query your analytics database using natural language.
...
- Network access from Cardinal Cloud to your ClickHouse instance
