...
- Network egress from Cardinal UI to `login.microsoftonline.com` and `graph.microsoft.com` (your network team may need to allow these in airgapped or restricted-egress deployments)
