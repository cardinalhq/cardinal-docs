...
3. Use that file as a template: substitute service names, thresholds or queries in your own tooling. If you exported a dashboard you added from the gallery, delete its `libraryRef` field. While that field is set, Cardinal UI keeps showing the gallery's version and ignores your changes.
