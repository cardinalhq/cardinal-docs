...
The [`cardinal-cursor-plugin`](https://github.com/cardinalhq/cardinal-cursor-plugin) puts your Cursor sessions on the [Agent Outcomes dashboard](/ui/agent-outcomes), matching the Claude Code and Codex CLI plugins:
